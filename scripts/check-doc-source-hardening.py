...
README_MARKERS: list[tuple[str, str]] = [
    ...
    ("git_remote_readiness_user", "git_user="),
    ...
    ("operational_wrapper_source", "Operational-Wrapper-Source-Hardening-Guard pruefen"),
    ("operational_wrapper_source_command", "scripts/check-operational-wrapper-source-hardening.py --summary"),
    ...
    ("backup_scope_helpers", "helper_binaries=<n>"),
    ("backup_scope_restic", "restic_binary=<pfad>"),
    ...
    ("systemd_parent_policy", "parent_policy_failures=0"),
    ("systemd_attr_policy", "attr_policy_failures=0"),
    ("systemd_attr_tools", "lsattr_available=1"),
    ("systemd_acl_tools", "acl_tool_available=0"),
    ("systemd_xattr_tools", "xattr_tool_available=0"),
...
SYSTEMD_README_MARKERS: list[tuple[str, str]] = [
    ...
    ("operational_wrapper_source_execstartpre", "ExecStartPre=/home/chris/web/br.m11h.eu/scripts/check-operational-wrapper-source-hardening.py --summary"),
    ("operational_wrapper_source_explanation", "Operational-Wrapper-Source-Hardening-Guard"),
...
READINESS_MARKERS: list[tuple[str, str]] = [
    ...
    ("backup_scope_helpers", "helper_binaries=4"),
    ("backup_scope_restic", "restic_binary=/usr/bin/restic"),
    ("backup_runtime_policy_guard", "Backup-Runtime-Policy-Guard"),
    ("backup_runtime_policy_status", "backup_runtime_policy_status=ok"),
    ("backup_runtime_policy_helpers", "helper_binaries=2"),
    ("backup_runtime_policy_restic", "restic_binary=/usr/bin/restic"),
    ...
    ("operational_wrapper_source_guard", "Operational-Wrapper-Source-Hardening-Guard"),
    ("operational_wrapper_source_status", "operational_wrapper_source_hardening_status=ok"),
    ("restore_runtime_policy_helpers", "helper_binaries=3"),
    ("restore_runtime_policy_restic", "restic_binary=/usr/bin/restic"),
    ("restore_runtime_policy_docker", "docker_binary=/usr/bin/docker"),
