...
SYSTEMD_UNIT_MARKERS: list[tuple[str, str]] = [
    ...
    ("summary", "systemd_unit_guard_status=ok checks=%d units=%d timers=%d services=%d sync_failures=0 missing_units=0 unit_policy_failures=0 inactive_timers=0 failed_services=0"),
]
