...
SYSTEMD_UNIT_MARKERS: list[tuple[str, str]] = [
    ...
    ("lsattr_bin", "LSATTR_BIN=\"$(command -v lsattr || true)\""),
    ("getfacl_bin", "GETFACL_BIN=\"$(command -v getfacl || true)\""),
    ("getfattr_bin", "GETFATTR_BIN=\"$(command -v getfattr || true)\""),
    ("checks_counter", "checks=0"),
    ("project_unit_owner", "project_unit_owner=\"$(stat -c '%U' \"${ROOT}/systemd\")\""),
    ("project_unit_group", "project_unit_group=\"$(stat -c '%G' \"${ROOT}/systemd\")\""),
