#!/usr/bin/env python3
"""Fix Cloudflare Access cookie settings for br.m11h.eu redirect flow."""
...
for app in apps:
    if app.get("domain") == DOMAIN or app.get("name") == DOMAIN:
        body = {
            ...
            "enable_binding_cookie": app.get("enable_binding_cookie", True),
        ...
        print("updated app_id=%s same_site_cookie_attribute=lax" % app["id"])
        raise SystemExit(0)
print("app_not_found")
raise SystemExit(1)
